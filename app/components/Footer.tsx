      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-10">
          <div className="col-span-2 md:col-span-1">
            <ZiggyDocsLogo />
            <p className="mt-4 text-[#b3b3b3] text-sm leading-relaxed">E-signatures without the enterprise price</p>
          </div>
          <div>
            <h4 className="text-white font-semibold text-sm mb-4">Product</h4>
            <ul className="space-y-3">
              {['/features','/pricing','/integrations','/compare/docusign','/blog','/changelog','/security','/faq'].map((href) => (
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="https://twitter.com/ziggydocs" target="_blank" rel="noopener noreferrer" className="text-[#b3b3b3] hover:text-white text-sm">Twitter / X</a></li>
              <li><a href="https://linkedin.com/company/ziggydocs" target="_blank" rel="noopener noreferrer" className="text-[#b3b3b3] hover:text-white text-sm">LinkedIn</a></li>
              <li><a href="https://youtube.com/@ziggydocs" target="_blank" rel="noopener noreferrer" className="text-[#b3b3b3] hover:text-white text-sm">YouTube</a></li>
            </ul>
          </div>
        </div>
